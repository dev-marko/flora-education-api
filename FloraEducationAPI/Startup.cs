...
namespace FloraEducationAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var dbConnectionString = $"Host=ec2-34-246-86-78.eu-west-1.compute.amazonaws.com;Database=d3s6emd1cr2pkl;Username=blnbhlkjtaexph;Password=63bfac8895daee59c9a8482c2633f198e67b4d6b4a4a30b9383af970376989fb;SSL Mode=Require;Trust Server Certificate=true";
